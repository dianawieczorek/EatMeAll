                    ...
                    <div className={styles.MealInfo}>
                        ...
                        <div className={styles.HoverButtons}>
                            ...
                            <button className={styles.Button} /*onClick={this.changeMealFromList}*/>
                                <FontAwesomeIcon className={styles.Icon} icon={faListUl} title="wybierz inną potrawę z listy"/>
                            </button>
                            <button className={styles.Button} /*onClick={this.deleteMealFromList}*/>
                                <FontAwesomeIcon className={styles.Icon} icon={faCalendarTimes} title="wyczyść/jem na mieście"/>
                            </button>
